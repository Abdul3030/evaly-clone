            ...
            <div className="container mx-auto py-3 px-2 flex flex-row justify-between items-center relative" >
                ...
                <div className="w-3/12 h-full hidden md:flex justify-between items-center icons">
                    ...
                    <div  className="p-2 rounded-full bg-gray-50 border border-gray-100 cursor-pointer">
                        ...
                        <svg onClick={() => setMessageOpen(prev => !prev)}  stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
                    </div>
                    <div className="p-2 rounded-full bg-gray-50 border border-gray-100 cursor-pointer ">
                        <Notification />
